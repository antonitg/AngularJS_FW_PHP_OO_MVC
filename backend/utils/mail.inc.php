...
class mail {
    static function setEmail($email) {
        ...
        switch ($email['type']) {
            ...
            case 'recover';
                ...
                $content .= '<a href = "https://antoni.jals.es/frontend/#/logreg/recover/' . $email['token'] . "'>Click here for recover your password.</a>";
                break;
                //////
            case 'verify';
                ...
                $content .= '<a href = "https://antoni.jals.es/frontend/#/logreg/verify/' . $email['token'] . '">Click here for verify your email.</a>';
                break;
                //////
        }// end_switch
        //////
    ...
    static function sendMailGun($values) {
        $ini_file = parse_ini_file($_SERVER['DOCUMENT_ROOT'] . '/model/credentials/apis.ini');
        $config = array();
