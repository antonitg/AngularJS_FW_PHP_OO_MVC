...
class router {
    ...
    function rountingStart() {
        try {
            ...
            echo "Error 29 routing en backedn".$e;
            // common::loadError();
    ...
    private function loadModule() {
        if (file_exists(SITE_ROOT.'general/resources/modules.xml')) {
			$modules = simplexml_load_file(SITE_ROOT.'general/resources/modules.xml');
